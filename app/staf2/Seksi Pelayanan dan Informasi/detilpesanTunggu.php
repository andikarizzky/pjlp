...
if (isset($_GET['tgl'])) {
    $tgl = $_GET['tgl'];
    $query = mysqli_query($koneksi, "SELECT * FROM permintaan WHERE tglManual='$tgl' AND NIP='$_SESSION[username]' AND Submit='berhasil' AND status=0  ORDER BY tglManual DESC");    
}
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                &nbsp;&nbsp;&nbsp;
                        <!--    <a data-toggle="tooltip"  class="ml-auto" data-original-title="Kembali" href="index.php?p=datapesananTunggu">
