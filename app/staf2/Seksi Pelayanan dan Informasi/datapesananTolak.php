...
$query = mysqli_query($koneksi, "SELECT distinct(tglManual), tgl_permintaan, jam, tglManual, count(id_permintaan)  FROM permintaan WHERE NIP= '$_SESSION[username]' AND status=2 AND Submit='berhasil' GROUP BY tglManual DESC ");	
?>
                ...
                <div class="card">           
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Laporan Di Tolak</h4>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tr>
                               ...
                               if (mysqli_num_rows($query)) {
                                 while($row=mysqli_fetch_assoc($query)):
                                  ...
                                  <td>             
                                     <a href="?p=detilpesanTolak&tgl=<?= $row['tglManual']; ?>"><span data-placement='top' data-toggle='tooltip' title='Detail Laporan'><button    class="btn btn-info btn-round btn-icon"><i class="fas fa-eye"></i></button></span></a>                  
                                 </td>
                             </tr>    
