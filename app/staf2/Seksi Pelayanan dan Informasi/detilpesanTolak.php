...
if (isset($_GET['tgl'])) {
    $tgl = $_GET['tgl'];
    $query = mysqli_query($koneksi, "SELECT * FROM permintaan WHERE tglManual='$tgl' AND NIP='$_SESSION[username]' AND status=2 ORDER BY tglManual DESC ");    
}
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                &nbsp;&nbsp;&nbsp;
                         <!--   <a data-toggle="tooltip"  class="ml-auto" data-original-title="Kembali" href="index.php?p=datapesananTolak">
                                ...
                                <tr>
                                    ...
                                    if (mysqli_num_rows($query)) {
                                        while($row=mysqli_fetch_array($query)):
                                           ...
                                           echo tanggal_indo($tgl);
                                           ?> </td>
                                           <td> <p class="text-danger"><?= $row['komentar']; ?></p>      
                                           </td>
                                           <td > <?php
                                           if ($row['status'] == 0){
                                    ...
                                    <td>    
                                        <a data-toggle="tooltip"  data-original-title="Edit" href="?p=editpesan&id=<?=$row['id_permintaan']; ?>"><button type="button"  class="btn btn-link btn-primary "> <i class="fa fa-edit"></i></button></a> 
                                    </td>
                                </tr>
