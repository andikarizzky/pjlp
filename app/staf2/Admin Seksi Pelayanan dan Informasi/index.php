...
$query2 = mysqli_query($koneksi, "SELECT NIP, tgl_permintaan, Akses, Keterangan, count(status) AS jumlah2 FROM permintaan WHERE status=0 AND submit='berhasil' AND Akses='Seksi Pelayanan dan Informasi'"); 
...
<body>
			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue">
				...
				<div class="container-fluid">
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<?php
						include '../../../fungsi/koneksi.php';
						$sql = 'SELECT NIP, Akses, penempatan, jam, count(NIP) FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=0 AND submit="berhasil" AND Akses="Seksi Pelayanan dan Informasi" GROUP BY NIP DESC limit 5';
						$query = mysqli_query($koneksi, $sql);
						$row = mysqli_fetch_array($query);
						$query2 = mysqli_query($koneksi, "SELECT NIP, tgl_permintaan, Akses, Keterangan, count(status) AS jumlah2 FROM permintaan WHERE status=0 AND submit='berhasil' AND Akses='Seksi Pelayanan dan Informasi'"); 
						$data2 = mysqli_fetch_assoc($query2);
						$query3 = mysqli_query($koneksi, "SELECT gambar, NIP, tgl_permintaan, Akses, Keterangan, count(status) AS jumlah3 FROM permintaan WHERE status=0 AND submit='berhasil' AND Akses='Seksi Pelayanan dan Informasi'"); 
					...
					<li class="nav-item dropdown hidden-caret">
						<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
							<div class="avatar-sm">
								...
								?>									
								<img src="../../staf2/foto/<?php echo $data['foto'];?>" alt="..." class="avatar-img rounded-circle">
							</div>
						</a>
							...
							<div class="dropdown-user-scroll scrollbar-outer">
								<li>
									<div class="user-box">
										...
										$data = mysqli_fetch_array($cek);
										?>											
										<div class="avatar-lg"><img src="../../staf2/foto/<?php echo $data['foto'];?>" alt="image profile" class="avatar-img rounded"></div>
										<div class="u-text">
											<h4>
							...
							<ul class="nav nav-collapse">
								<li>
									...
									<a href="index.php?p=userStaff">		
										<span class="sub-item">Data Pengguna Seksi Pelayanan dan Informasi</span>
									</a>
								</li>
							</ul>
						</div>
	...
	<script>
		...
		<?php
		include "../../../fungsi/koneksi.php";
		$tunggu1       = mysqli_query($koneksi, "SELECT count(status) AS jumlah01 FROM permintaan where status=0 AND submit='berhasil' AND Akses='Seksi Pelayanan dan Informasi' ");
		$tolak1       = mysqli_query($koneksi, "SELECT count(status) AS jumlah11 FROM permintaan where status=2 AND submit='berhasil' AND Akses='Seksi Pelayanan dan Informasi' ");
		$terima1       = mysqli_query($koneksi, "SELECT count(status) AS jumlah21 FROM permintaan where status=1  AND submit='berhasil'AND Akses='Seksi Pelayanan dan Informasi' ");
		?>
