...
$query = mysqli_query($koneksi, "SELECT distinct(NIP), NamaPegawai, Pegawai, NIP, AtasanSatu, tgl_permintaan, jam, tglManual, penempatan, level, Akses, count(tglManual) FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE Akses='Seksi Pelayanan dan Informasi' AND Submit='berhasil' AND status=2 GROUP BY NIP"); 
?>
<body>
        ...
        <div class="col-md-12">
            <div class="card">           
                <div class="card-header">
                    <div class="card-title">Data Laporan Tolak Seksi Pelayanan dan Informasi</div>
                </div>
                <div class="card-body">
