...
if (isset($_GET['tgl']) && isset($_GET['NIP']) && isset($_GET['Pegawai'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT catatan, gambar, jamManual2, tglManual, status, jamManual, Keterangan  FROM permintaan  WHERE tglManual='$tgl' AND NIP='$NIP' AND Pegawai='$Pegawai' AND Submit='berhasil' ORDER BY tglManual DESC ");    
}
?>
