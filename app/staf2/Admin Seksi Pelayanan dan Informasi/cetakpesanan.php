...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
  ...
  <table class="tabel2">
    ...
    <tbody align="center">
      ...
      $sql = mysqli_query($koneksi, "SELECT * FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=1 AND Akses='Seksi Pelayanan dan Informasi' ORDER BY tglManual AND NIP DESC");  
      $i   = 1;
      while($datalaporan=mysqli_fetch_array($sql))
      {
        ...
        <tr>
          ...
          <td style="text-align: left; height:100px; width=135px;"><?php echo $datalaporan['catatan']; ?></td>
          <td style="text-align: left; height:100px; width=135px;"><?php echo $datalaporan['Keterangan']; ?></td>
