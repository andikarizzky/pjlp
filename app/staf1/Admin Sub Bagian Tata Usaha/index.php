...
$query2 = mysqli_query($koneksi, "SELECT NIP, tgl_permintaan, Akses, Keterangan, count(status) AS jumlah2 FROM permintaan WHERE status=0 AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha'"); 
			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue">
				<div class="container-fluid">
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<?php
						include '../../../fungsi/koneksi.php';
						$sql = 'SELECT NIP, Akses, penempatan, jam, count(NIP) FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=0 AND submit="berhasil" AND Akses="Sub Bagian Tata Usaha" GROUP BY NIP DESC limit 5';
						$query = mysqli_query($koneksi, $sql);
						$row = mysqli_fetch_array($query);
						$query2 = mysqli_query($koneksi, "SELECT NIP, tgl_permintaan, Akses, Keterangan, count(status) AS jumlah2 FROM permintaan WHERE status=0 AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha'"); 
						$data2 = mysqli_fetch_assoc($query2);
						$query3 = mysqli_query($koneksi, "SELECT gambar, NIP, tgl_permintaan, Akses, Keterangan, count(status) AS jumlah3 FROM permintaan WHERE status=0 AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha'"); 
					...
					<li class="nav-item dropdown hidden-caret">
						<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
							<div class="avatar-sm">
								...
								?>									
								<img src="../../staf1/foto/<?php echo $data['foto'];?>" alt="..." class="avatar-img rounded-circle">
							</div>
						</a>
							...
							<div class="dropdown-user-scroll scrollbar-outer">
								<li>
									<div class="user-box">
										...
										$data = mysqli_fetch_array($cek);
										?>											
										<div class="avatar-lg"><img src="../../staf1/foto/<?php echo $data['foto'];?>" alt="image profile" class="avatar-img rounded"></div>
										<div class="u-text">
											<h4>
			...
			<div class="sidebar-content">
				<div class="user">
					<div class="avatar-sm float-left mr-2">
						<img src="../../../IT/foto/<?php echo $data['foto'];?>" alt="..." class="avatar-img rounded-circle">
					</div>
					<div class="info">
							...
							<ul class="nav nav-collapse">
								<li>
									...
									<a href="index.php?p=userStaff">		
										<span class="sub-item">Data Pengguna Sub Bagian Tata Usaha</span>
									</a>
								</li>
							</ul>
						</div>
...
<script>
		...
		<?php
		include "../../../fungsi/koneksi.php";
		$tunggu       = mysqli_query($koneksi, "SELECT count(status) AS jumlah0 FROM permintaan where status=0  AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha'");
		$tolak       = mysqli_query($koneksi, "SELECT count(status) AS jumlah1 FROM permintaan where status=2 AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha' ");
		$terima       = mysqli_query($koneksi, "SELECT count(status) AS jumlah2 FROM permintaan where status=1 AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha' ");
		?>
		...
		<?php
		include "../../../fungsi/koneksi.php";
		$tunggu1       = mysqli_query($koneksi, "SELECT count(status) AS jumlah01 FROM permintaan where status=0 AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha' ");
		$tolak1       = mysqli_query($koneksi, "SELECT count(status) AS jumlah11 FROM permintaan where status=2 AND submit='berhasil' AND Akses='Sub Bagian Tata Usaha' ");
		$terima1       = mysqli_query($koneksi, "SELECT count(status) AS jumlah21 FROM permintaan where status=1  AND submit='berhasil'AND Akses='Sub Bagian Tata Usaha' ");
		?>
