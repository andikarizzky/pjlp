                                                ...
                                                <div class="card-body ">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col col-stats ml-3 ml-sm-0">
                                                            <div class="numbers">
                                                                <p class="card-category">Admin Sub Bagian Tata Usaha</p>
                                                                <?php
                                                                include "../../../fungsi/koneksi.php";
                                                                $kueri = mysqli_query($koneksi, "SELECT * FROM user WHERE level='Admin Sub Bagian Tata Usaha' ");
                                                                $data = array ();
                                        ...
                                        <div class="card card-stats card-round">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col col-stats ml-3 ml-sm-0">
                                                        <div class="numbers">
                                                            <p class="card-category">Sub Bagian Tata Usaha</p>
                                                            <?php
                                                            include "../../../fungsi/koneksi.php";
                                                            $kueri = mysqli_query($koneksi, "SELECT * FROM user WHERE level='Sub Bagian Tata Usaha'");
                                                            $data = array ();
                                                            while (($row = mysqli_fetch_array($kueri)) != null){
                                                             $data[] = $row;
                                                         }
