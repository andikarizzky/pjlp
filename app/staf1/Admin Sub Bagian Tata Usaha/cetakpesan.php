...
$query = mysqli_query($koneksi, "SELECT distinct(tglManual), NIP, Pegawai, tglManual, tgl_permintaan FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=1 AND Akses='Sub Bagian Tata Usaha' GROUP BY tglManual DESC ");   
?>
