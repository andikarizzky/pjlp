...
$query = mysqli_query($koneksi, "SELECT distinct(tglManual), NIP, Pegawai, tglManual, tgl_permintaan FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=1 AND Akses!='Sub Bagian Tata Usaha' AND Akses!='Admin Sub Bagian Tata Usaha' AND Akses!='Seksi Pelayanan dan Informasi' AND Akses!='Admin Seksi Pelayanan dan Informasi' AND Akses!='Seksi Prasarana dan Sarana' AND Akses!='Admin Seksi Prasarana dan Sarana' AND Akses!='Admin Seksi Konservarsi Peragaan Penelitian dan Pengembangan' GROUP BY tglManual DESC ");   
?>
