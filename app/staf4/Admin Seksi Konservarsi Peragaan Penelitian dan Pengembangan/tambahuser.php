                        ...
                        <div class="form-group form-show-validation row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-8">
                                <select  name="level" class="form-control">
                                    ...
                                    <option value="Satuan Pelaksana Pendidikan dan Kerjasama Antar Lembaga Konservarsi">Satuan Pelaksana Pendidikan dan Kerjasama Antar Lembaga Konservarsi</option>
                                    <option value="Satuan Pelaksana Kesejahteraan Satwa">Satuan Pelaksana Kesejahteraan Satwa</option>
                                    <option value="Satuan Pelaksana Pakan Satwa">Satuan Pelaksana Pakan Satwan</option>
                                </select>
                            </div>
                        </div>    
