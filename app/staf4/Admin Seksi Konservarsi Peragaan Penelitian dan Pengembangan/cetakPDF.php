...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
  ...
  <hr>
  <p align="center" style="font-weight: bold; font-size: 18px;"><u>LAPORAN KESELURUAHAN DI SETUJUI</u></p>
  <?php 
  ...
  <table class="tabel2">
    ...
    <tbody align="center">
      <?php
      $sql = mysqli_query($koneksi, "SELECT * FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=1 AND Akses!='Sub Bagian Tata Usaha' AND Akses!='Admin Sub Bagian Tata Usaha' AND Akses!='Seksi Pelayanan dan Informasi' AND Akses!='Admin Seksi Pelayanan dan Informasi' AND Akses!='Seksi Prasarana dan Sarana' AND Akses!='Admin Seksi Prasarana dan Sarana' AND Akses!='Admin Seksi Konservarsi Peragaan Penelitian dan Pengembangan' ORDER BY tglManual AND NIP DESC");  
      $i   = 1;
      while($datalaporan=mysqli_fetch_array($sql))
      {
        ...
        <tr>
          ...
          <td style="text-align: left; height:80px; width=55px;"><?php echo $datalaporan['Pegawai']; ?></td>
          <td style="text-align: left; height:100px; width=100px;"><?php echo $datalaporan['catatan']; ?></td>
          <td style="text-align: left; height:100px; width=100px;"><?php echo $datalaporan['Keterangan']; ?></td>
          <td style="text-align: center; width=25px;"><?php echo $datalaporan['jamManual']; ?> - <?php echo $datalaporan['jamManual2']; ?></td> 
          <td style="text-align: center; height:100px; width=50px;"><?php echo tanggal_indokedua($datalaporan['tglManual']); ?></td>
          <td style="text-align: center; height:100px; width=50px;"><?php echo $datalaporan['penempatan']; ?></td> 
