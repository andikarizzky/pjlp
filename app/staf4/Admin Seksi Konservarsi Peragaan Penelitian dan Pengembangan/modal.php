...
if (isset($_GET['id']) && isset($_GET['tgl'])) {
  $id = $_GET['id'];
  $query = mysqli_query($koneksi, "SELECT NIP, tgl_permintaan, tglManual, id_permintaan FROM permintaan WHERE id_permintaan = $id ");
        ...
        <div class="row">
            <div class="col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <form method="post" id="bs-validate-demo" novalidate action="edit_modal.php" class="form-horizontal">
                        <div class="box-body">
                        ...
                        <div class="form-group form-show-validation row">
                            <label for="komentar" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Komentar</label>
                            <div class="col-lg-4 col-md-9 col-sm-8">
                                <input id="komentar" type="text" required="isikan dulu" class="form-control" name="komentar" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;
                        <!--    <a data-toggle="tooltip"  class="ml-auto" data-original-title="Kembali" href="?p=detil3Tunggu&tgl=<?=// $row2['tgl_permintaan']; ?>">
