                                ...
                                <div class="col-md-6 col-lg-12">
                                    <div class="box box-primary">
                                        <div class="card">
                                            ...
                                            <div class="card-body">              
                                                <form enctype="multipart/form-data" id="bs-validate-demo" novalidate method="post"  action="edituprosesPerorangan.php" class="form-horizontal">
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group form-show-validation row">
                                                            ...
                                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                                <select id="level"  class="form-control" name="level">
                                                                    ...
                                                                    <option  <?php if($row2['level'] == "Sub Bagian Tata Usaha") echo "selected"; ?>  value="Sub Bagian Tata Usaha">Sub Bagian Tata Usaha</option>

                                                                    <option  <?php if($row2['level'] == "Seksi Pelayanan dan Informasi") echo "selected"; ?>  value="Seksi Pelayanan dan Informasi">Seksi Pelayanan dan Informasi</option>

                                                                    <option  <?php if($row2['level'] == "Seksi Prasarana dan Sarana") echo "selected"; ?>  value="Seksi Prasarana dan Sarana">Seksi Prasarana dan Sarana</option> 

                                                                    <option  <?php if($row2['level'] == "Seksi Konservarsi Peragaan Penelitian dan Pengembangan") echo "selected"; ?>  value="Seksi Konservarsi Peragaan Penelitian dan Pengembangan">Seksi Konservarsi Peragaan Penelitian dan Pengembangan</option>

                                                                    <option  <?php if($row2['level'] == "Satuan Pelaksana Pendidikan dan Kerjasama Antar Lembaga Konservarsi") echo "selected"; ?>  value="Satuan Pelaksana Pendidikan dan Kerjasama Antar Lembaga Konservarsi">Satuan Pelaksana Pendidikan dan Kerjasama Antar Lembaga Konservarsi</option> 

                                                                    <option  <?php if($row2['level'] == "Satuan Pelaksana Kesejahteraan Satwa") echo "selected"; ?>  value="Satuan Pelaksana Kesejahteraan Satwa">Satuan Pelaksana Kesejahteraan Satwa</option> 

                                                                    <option  <?php if($row2['level'] == "Satuan Pelaksana Pakan Satwa") echo "selected"; ?>  value="Satuan Pelaksana Pakan Satwa">Satuan Pelaksana Pakan Satwa</option> 
