                                        ...
                                        <tr>
                                            ...
                                            if (mysqli_num_rows($query)) {
                                                while($row=mysqli_fetch_assoc($query)):
                                                   ...
                                                   <td>                                     <a data-original-title="Lihat"  data-toggle="tooltip" href="?p=disetujui2&NIP=<?= $row['NIP'];?>&Pegawai=<?= $row['Pegawai'];?>"><button type="button" class="btn btn-icon btn-round btn-info">
