...
$query = mysqli_query($koneksi, "SELECT * FROM user WHERE level!='Sub Bagian Tata Usaha' AND level!='Seksi Pelayanan dan Informasi' AND level!='Seksi Prasarana dan Sarana' AND level!='Seksi Konservarsi Peragaan Penelitian dan Pengembangan' AND level!='IT' AND level!='Seksi Konservarsi Peragaan Penelitian dan Pengembangan' AND level!='Satuan Pelaksana Pendidikan dan Kerjasama Antar Lembaga Konservarsi' AND level!='Satuan Pelaksana Kesejahteraan Satwa' AND level!='Satuan Pelaksana Pakan Satwa' ORDER BY level DESC");	
?>
