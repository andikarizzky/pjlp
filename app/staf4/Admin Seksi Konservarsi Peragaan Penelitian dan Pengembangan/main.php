                                                ...
                                                <div class="card-body ">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col col-stats ml-3 ml-sm-0">
                                                            <div class="numbers">
                                                                <p class="card-category">Admin Seksi Konservarsi Peragaan Penelitian dan Pengembangan</p>
                                                                <?php
                                                                include "../../../fungsi/koneksi.php";
                                                                $kueri = mysqli_query($koneksi, "SELECT * FROM user WHERE level='Admin Seksi Konservarsi Peragaan Penelitian dan Pengembangan' ");
                                                                $data = array ();
                                        ...
                                        <div class="card card-stats card-round">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col col-stats ml-3 ml-sm-0">
                                                        <div class="numbers">
                                                            <p class="card-category">Seksi Konservarsi Peragaan Penelitian dan Pengembangan</p>
                                                            <?php
                                                            include "../../../fungsi/koneksi.php";
