                                                        ...
                                                        <div class="form-group form-show-validation row">
                                                            ...
                                                            <div class="col-lg-4 col-md-9 col-sm-8">
                                                                <select id="level"  class="form-control" name="level">
                                                                    ...
                                                                    <option  <?php if($row2['level'] == "Admin Seksi Konservarsi Peragaan Penelitian dan Pengembangan") echo "selected"; ?>  value="Admin Seksi Konservarsi Peragaan Penelitian dan Pengembangan">Admin Seksi Konservarsi Peragaan Penelitian dan Pengembangan</option>                                       </select>
                                                            </div>
                                                        </div>
                                                        <div class="separator-solid"></div>
