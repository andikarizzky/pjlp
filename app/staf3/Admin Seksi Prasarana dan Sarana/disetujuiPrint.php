...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
  ...
  <table align="left">
    ...
    <?php 
    $query3 = mysqli_query($koneksi, "SELECT * FROM permintaan WHERE NIP='$NIP' AND  status=1");
  ...
  <div class="kanan2">
    <img style="width:110px;height:110px" src="../../staf3/foto/<?php echo $data['foto'];?>">
  </div>
  <br> 
  <table class="tabel2">
    <thead align="center">
    ...
    <tbody align="center">
      <?php
      $sql = mysqli_query($koneksi, "SELECT * FROM permintaan WHERE NIP='$NIP' AND  status=1 ");  
      $i   = 1;
      while($datalaporan=mysqli_fetch_array($sql))
      {
        ...
        <tr>
          ...
          <td style="text-align: left; height:80px; width=197px;"><?php echo $datalaporan['catatan']; ?></td>
          <td style="text-align: left; height:80px; width=197px;"><?php echo $datalaporan['Keterangan']; ?></td>
          <td style="text-align: center; width=100px;"><?php echo $datalaporan['jamManual']; ?> - <?php echo $datalaporan['jamManual2']; ?></td> 
          <td style="text-align: center; height:80px; width=100px;"><?php echo tanggal_indokedua($datalaporan['tglManual']); ?></td> 
        </tr>
        <?php
        $i++;
      }
