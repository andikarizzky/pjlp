...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
  ...
  <hr>
  <?php 
  $query2 = mysqli_query($koneksi, "SELECT * FROM user WHERE username='$NIP' AND NamaPegawai='$Pegawai' ");
  ...
  <table align="left">
    ...
    <?php 
    $query3 = mysqli_query($koneksi, "SELECT * FROM permintaan WHERE tglManual='$tgl' AND NIP='$NIP' AND Pegawai='$Pegawai' AND  status=1 ");
  ...
  <div class="kanan2">
    <img style="width:123px;height:140px" src="../../staf3/foto/<?php echo $data['foto'];?>">
  </div>
  <br> 
  <table class="tabel2">
    <thead align="center">
    ...
    <tbody align="center">
      <?php
      $sql = mysqli_query($koneksi, "SELECT * FROM permintaan WHERE status=1 AND tglManual='$tgl' AND NIP='$NIP' AND Pegawai='$Pegawai' ");  
      $i   = 1;
