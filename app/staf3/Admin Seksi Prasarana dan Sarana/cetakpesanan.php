...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
  ...
  <table class="tabel2">
    ...
    <tbody align="center">
      ...
      $sql = mysqli_query($koneksi, "SELECT penempatan, AtasanSatu, jamManual2, status, catatan, NIP, jamManual, Akses, Pegawai, Keterangan, tgl_permintaan FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE  status=1 AND Akses='Seksi Prasarana dan Sarana' AND tglManual='$tgl' ORDER BY NIP DESC");  
      $i   = 1;
