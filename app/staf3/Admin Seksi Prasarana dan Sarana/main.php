                                                ...
                                                <div class="card-body ">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col col-stats ml-3 ml-sm-0">
                                                            <div class="numbers">
                                                                <p class="card-category">Admin Seksi Prasarana dan Sarana</p>
                                                                <?php
                                                                include "../../../fungsi/koneksi.php";
                                                                $kueri = mysqli_query($koneksi, "SELECT * FROM user WHERE level='Admin Seksi Prasarana dan Sarana' ");
                                                                $data = array ();
                                        ...
                                        <div class="card card-stats card-round">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col col-stats ml-3 ml-sm-0">
                                                        <div class="numbers">
                                                            <p class="card-category">Seksi Prasarana dan Sarana</p>
                                                            <?php
                                                            include "../../../fungsi/koneksi.php";
                                                            $kueri = mysqli_query($koneksi, "SELECT * FROM user WHERE level='Seksi Prasarana dan Sarana'");
                                                            $data = array ();
                                                            while (($row = mysqli_fetch_array($kueri)) != null){
                                                             $data[] = $row;
                                                         }
