...
$query = mysqli_query($koneksi, "SELECT distinct(NIP), NamaPegawai, Pegawai, AtasanSatu, tgl_permintaan, jam, tglManual, penempatan, level, Akses, count(tglManual) FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE Akses='Seksi Prasarana dan Sarana' AND Submit='berhasil' AND status=0 GROUP BY NIP"); 
?>
<body>
        ...
        <div class="col-md-12">
            <div class="card">           
                <div class="card-header">
                    <div class="card-title">Data Laporan Tunggu Seksi Prasarana dan Sarana</div>
                </div>
                <div class="card-body">
