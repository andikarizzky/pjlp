...
$query = mysqli_query($koneksi, "SELECT distinct(NIP), Pegawai, NamaPegawai, tgl_permintaan, jam, tglManual, penempatan, AtasanSatu, level, Akses, count(tglManual) FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE Akses='Seksi Prasarana dan Sarana' AND Submit='berhasil' GROUP BY NIP"); 
?>
<body>
    ...
    <div class="col-md-12">
        <div class="card">           
            <div class="card-header">
                <div class="card-title">Data Laporan Seksi Prasarana dan Sarana</div>
            </div>
            <div class="card-body">
