...
$query = mysqli_query($koneksi, "SELECT * FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=1 AND Akses='Seksi Prasarana dan Sarana' ORDER BY tglManual AND NIP DESC "); 
?>
