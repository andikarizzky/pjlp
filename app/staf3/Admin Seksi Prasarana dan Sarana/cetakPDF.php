...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
  ...
  <table class="tabel2">
    ...
    <tbody align="center">
      <?php
      $sql = mysqli_query($koneksi, "SELECT * FROM permintaan LEFT JOIN user on permintaan.NIP = user.username WHERE status=1 AND Akses='Seksi Prasarana dan Sarana' ORDER BY tglManual AND NIP DESC");  
      $i   = 1;
