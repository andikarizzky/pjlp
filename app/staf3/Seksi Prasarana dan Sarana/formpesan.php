            ...
            <div class="card-body">
                <table  id="basic-datatables" class="table table-responsive display table table-striped table-hover table-head-bg-info">
                    ...
                    <tbody align="center">
                        <tr>
                            <?php 
                            $sql = "SELECT * FROM permintaan WHERE Akses='Seksi Prasarana dan Sarana' AND Submit!='berhasil' ";
                            ...
                            if(mysqli_num_rows($queryTampil) > 0) {
                                while($row = mysqli_fetch_assoc ($queryTampil)):
                                   ...
                                   <td align="left"><img src="../../../IT/gambar/<?php echo $row['gambar'];?>" height="50" width="100" alt='Tidak Ada Foto'>
                                   </td>
